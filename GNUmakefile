...
QEMUOPTS = -drive file=$(OBJDIR)/kern/kernel.img,index=0,media=disk,format=raw -serial mon:stdio -gdb tcp::$(GDBPORT) -vga std -m 256m
...
.PHONY: all always \
	 tarball tarball-pref clean realclean distclean grade handin-prep handin-check
